...
const Arrows = () => {
    return (
        <div className="Testimonials-arrows">
            <a href="#" title="Right Arrow" className="Testimonials-arrow Testimonials-arrow--left">
            ...
            <Dots/>
            <a href="#" title="Left Arrow" className="Testimonials-arrow Testimonials-arrow--right">
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="Testimonial-arrowImg" viewBox="0 0 16 16">
