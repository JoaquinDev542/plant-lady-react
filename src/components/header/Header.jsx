...
const Logo = () => {
    return (
        <h1 className="Header-h1"><img src="./assets/brand/logo.webp" alt="PLANT LADY JUICE CO." className="Header-logo" /></h1>
    )
}

const Cart = () => {
    return (
        <a href="#" title="cart" className="Header-cart"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="Header-cartImg" viewBox="0 0 16 16">
...
const Delivery = () =>  { 
   return (
    <a href="#" title="Delivery Car" className="Header-navContainerLink">
